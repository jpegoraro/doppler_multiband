...
#path= 'plots/new_sim/absolute/2_static/varying_k/'
path='plots/test/'
for f in[28,60]:
...
#     path = 'plots/new_sim/absolute/varying_path/'
...
# path='plots/new_sim/absolute/2_static/p_std/'
# path='plots/test/'
